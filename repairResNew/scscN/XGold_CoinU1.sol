...
library SafeMath {
	...
	function destroy(uint256 _amount, address destroyer) onlyOwner public {
	...
	function setNewWallet(address newWallet) onlyOwner public {
	...
	constructor() Crowdsale public {
	investors = 0;
	}
	function buyXgoldTokens(address _sender) payable public {
	investors++;
	buyTokens(_sender);
	}
	function () payable public {
	...
	function sendTokens(address _beneficiary, uint256 _amount) onlyOwner payable public {
	investors++;
