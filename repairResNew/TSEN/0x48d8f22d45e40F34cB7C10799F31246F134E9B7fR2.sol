...
contract OraclizeI {
	...
	function updateMaxMinComparables(uint updatedMaxBet, uint updatedMinBet, uint updatedBaseComparable) ownerAction public {
	...
	function updateRewardToken(address updatedToken, uint updatedRewardAmount) ownerAction public {
	...
	function updateGameSpecifics(uint newGas, uint newMultiplier) ownerAction public {
	callbackGas = newGas;
