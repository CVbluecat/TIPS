...
contract ERC20Basic {
	...
	event GoalReached();
	constructor(address aVaultAddress, uint aStart, uint aPeriod, uint aGoal, uint aRate) public {
	...
	function TransferTokenOwnership(address newTokenOwner) onlyOwner public {
	...
	function refundInvestor(address aInvestorAddress) onlyOwner public returns(bool ){
	...
	function isContractActive() public returns(bool ){
