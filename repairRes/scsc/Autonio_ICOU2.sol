...
contract Token {
	...
	constructor(string n, string a, uint256 totalSupplyToUse, bool isSecured, bool cMB, string physical, string crypto, uint256 txnTaxToUse, uint256 holdingTaxToUse, uint256 holdingTaxIntervalToUse, bool isPrivateToUse) public {
	name = n;
	symbol = a;
	...
	constructor(address tokenAddress, uint256 noOfTokens, uint256 prPerToken) public {
	dates[0] = 1505520000;
	dates[1] = 1506470400;
	dates[2] = 1507161600;
	dates[3] = 1507852800;
	...
	function updatePresaleNumbers() public {
	if(msg.sender == owner){
	...
	if(weiLeftOver > 0){
	msg.sender.transfer(weiLeftOver);
	}
	}
	event Transfer(address indexed _from, address indexed _to, uint256 _value);
