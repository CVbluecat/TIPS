...
contract TokenInterface {
	...
	if(! hackerGold.transfer(proposals[id].submitter, proposals[id].value)){
	throw;}
	}
	else{
	...
	if(! hackerGold.transfer(msg.sender, getHKGOwned())){
	throw;}
	}
	...
	require(virtualExchangeAddress == msg.sender);
